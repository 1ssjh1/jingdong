export { lunbo0, lunbo1, get, post, postForm, getMessage, postFormDate, getToken, postddd, seconds_kill, car_put, postToken, post_comment, delete_comment, find, getToken_msg, post_recharge }
...
// -------------------------------------
async function postFormDate(url, Form, token) {
    const require = await fetch(`${Base_Url}${url}`, {
        method: "POST",
        headers: {
            'Authorization': `${token}`,
...
async function postddd(url, token, data) {
    const require = await fetch(`${Base_Url}${url}`, {
        method: "POST",
        headers: {
            'Authorization': `${token}`,
...
async function car_put(url, token, data) {
...
async function post_comment(url, token, data) {
    const require = await fetch(`${Base_Url}${url}`, {
        method: "POST",
        headers: {
            'Authorization': `${token}`,
...
async function delete_comment(url, token, data) {
    const require = await fetch(`${Base_Url}${url}`, {
        method: "Delete",
        headers: {
            'Authorization': `${token}`,
...
async function getToken_msg(url, token, data) {
    const require = await fetch(`${Base_Url}${url}${data}`, {
        // credentials: 'include',
        headers: {
            'Authorization': `${token}`
        }
...
async function post_recharge(url, token, data) {
